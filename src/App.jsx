...
function UserChip({ user, onLogout, onAdmin, onProfile }) {
  ...
  return (
    ...
    >
      {/* ── Trigger Button — safe fixed-size, no overflow ── */}
      <button
        onClick={() => setOpen((v) => !v)}
        style={{
          width: 42,
      ...
      >
        {hasPhoto ? (
          ...
          <span style={{ fontWeight: 900, fontSize: 15, color: "#111", userSelect: "none" }}>
            {ini}
          </span>
        )}
      </button>
            ...
            >
              ...
              >
                {hasPhoto ? (
                  ...
                  <span style={{ fontWeight: 900, fontSize: 14, color: "#111" }}>{ini}</span>
                )}
              </div>
